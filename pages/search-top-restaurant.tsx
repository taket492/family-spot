    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary-50 via-neutral-50 to-primary-50">
      <div className="page-container py-8">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <div className="inline-flex items-center justify-center size-20 rounded-3xl bg-gradient-secondary shadow-lg mb-6 animate-bounce-soft">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between text-sm text-neutral-600">
              <div className="flex items-center">
                <svg className="size-4 mr-2 text-secondary-500" fill="currentColor" viewBox="0 0 20 20">
            ...
            {featureTags.map((feature, index) => (
              ...
              >
                <CardContent className="p-6 text-center">
                  <div className={`inline-flex items-center justify-center size-16 rounded-2xl bg-gradient-to-br ${feature.color} shadow-lg mb-4 text-3xl group-hover:scale-110 transition-transform duration-200`}>
                    {feature.icon}
                  </div>
